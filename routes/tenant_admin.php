...
Route::middleware([
   ...
   -------------------------------------------- */
    ...
    /* ------------------------------------------
     Google Analytics MANAGE ROUTES
   -------------------------------------------- */
    Route::controller(\App\Http\Controllers\AnalyticsController::class)->name('tenant.')->prefix('google')->group(function (){
        Route::get('/analytics','analytics')->name('admin.google.analytics');
        Route::get('/tag-manager','tagManager')->name('admin.google.tag.manager');
        Route::get('/ad-manager','adManager')->name('admin.google.ad.manager');
        Route::get('/search-console','searchConsole')->name('admin.google.search.console');
        Route::post('/update/google/settings','googleSettingsUpdate')->name('admin.google.settings.update');
    });
...
-------------------------------------------- */
    Route::controller(\App\Http\Controllers\Landlord\Admin\PaymentSettingsController::class)->prefix('payment-settings')->group(function (){
        ...
        Route::get('/bkash','bkash_settings')->name('admin.payment.bkash.settings');
