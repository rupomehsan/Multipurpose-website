...
use App\Http\Controllers\DomainManageController;
...
Route::middleware(['landlord_glvar','maintenance_mode','setlang'])->controller(\App\Http\Controllers\Landlord\Frontend\LandlordFrontendController::class)->group(function (){
    Route::post('send/otp',[SmsController::class,'sms_send'])->name('send.otp');
    Route::post('verify/otp',[SmsController::class,'verifyOtp'])->name('verify.otp');
    Route::post('/generate/business-name/',[OpenAiController::class,'suggestBusinessName'])->name('get.business.name');
    Route::post('/check/domain-satatus/',[DomainManageController::class,'checkDomainStatus'])->name('check.domain.status');
    Route::post('/get-all-themes','getAllTheme')->name('get.all.themes');
    Route::post('/store/aws/s3',[HomeController::class,'storeImage']);
...
Route::middleware(['maintenance_mode','landlord_glvar'])->controller(PaymentLogController::class)->name('landlord.')->group(function () {
    ...
    Route::post('/bkash', 'BkashTokenizePaymentController@callBack')->name('frontend.bkash.ipn');
    ...
    Route::group(["controller" => BkashController::class], function () {

        Route::get("pay/bkash", "payWithBkash")->name("pay-with-bkash");
...
Route::middleware(['landlord_glvar','maintenance_mode','setlang','Google2FA','setlang'])->controller(\App\Http\Controllers\Landlord\Frontend\LandlordFrontendController::class)->name('landlord.')->group(function () {
    ...
    Route::get('register/create-business','tenant_create_user_business')->name('user.business.create');
