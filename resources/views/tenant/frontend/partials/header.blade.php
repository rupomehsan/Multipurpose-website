...
<head>
    ...
    @if (get_static_option('google_ad_manager'))
        {!! get_static_option('google_ad_manager')!!}
    @endif
    @if (get_static_option('google_search_console'))
        {!! get_static_option('google_search_console')!!}
    @endif
    @if (get_static_option('google_tag_manager'))
        {!! get_static_option('google_tag_manager')!!}
    @endif
