...
namespace Modules\HotelBooking\Http\Pagebuilder\Addons\Blogs;
...
class BlogArea extends PageBuilderBase
{
    ...
    public function admin_render()
    {
        ...
        foreach ($all_languages as $key => $lang) {
            ...
            $output .= Text::get([
                'name' => 'bottom_text_url_'.$lang->slug,
                'label' => __('Bottom Text Url'),
                'value' => $widget_saved_values['bottom_text_url_'.$lang->slug] ?? null,
            ]);
    ...
    public function frontend_render()
    {
        ...
        $bottom_text_url = $this->setting_item('bottom_text_url_'.$current_lang);
        $padding_top = SanitizeInput::esc_html($this->setting_item('padding_top'));
        $padding_bottom = SanitizeInput::esc_html($this->setting_item('padding_bottom'));

        $blog_category = BlogCategory::find($category);
        ...
        $data = [
            ...
            'bottom_text_url'=> $bottom_text_url,
            'blogs'=> $blogs,
        ...
        return self::renderView('blogs.blog-area', $data, 'HotelBooking');
    }

    public function addon_title()
    {
        return __('BlogArea (Hotel Booking)');
    }
}
