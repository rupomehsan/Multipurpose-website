...
namespace Modules\HotelBooking\Http\Pagebuilder\Addons\Shots;
...
class ShotArea extends PageBuilderBase
{
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('shots.shot-area', $data, 'HotelBooking');
    }

    public function addon_title()
    {
        return __('ShotArea (Hotel Booking)');
    }
}
