...
class SidebarMenuHelper
{
    ...
    public function render_sidebar_menus(): string
    {
        ...
        $this->google_settings($menu_instance);
    ...
    private function google_settings(MenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('google-settings-menu-items', [
            'route' => '#',
            'label' => __('Google Services'),
            'parent' => null,
            'permissions' => ['google-analytics', 'google-search-console', 'google-tag-manager','google-settings-update','google-ad-manager'],
            'icon' => 'mdi mdi-google-analytics',
        ]);
        $menu_instance->add_menu_item('google-settings-analytics-page-settings', [
            'route' => 'landlord.admin.google.analytics',
            'label' => __('Google Analytics'),
            'parent' => 'google-settings-menu-items',
            'permissions' => ['google-analytics'],
        ]);
        $menu_instance->add_menu_item('google-settings-search-console-page-settings', [
            'route' => 'landlord.admin.google.search.console',
            'label' => __('Search Console'),
            'parent' => 'google-settings-menu-items',
            'permissions' => ['google-search-console'],
        ]);
        $menu_instance->add_menu_item('google-settings-tag-manager-page-settings', [
            'route' => 'landlord.admin.google.tag.manager',
            'label' => __('Google Tag Manager'),
            'parent' => 'google-settings-menu-items',
            'permissions' => ['google-tag-manager'],
        ]);
        $menu_instance->add_menu_item('google-settings-ad-manager-page-settings', [
            'route' => 'landlord.admin.google.ad.manager',
            'label' => __('Google Ad Manager'),
            'parent' => 'google-settings-menu-items',
            'permissions' => ['google-ad-manager'],
        ]);
    ...
    private function payment_gateway_manage_menus(MenuWithPermission $menu_instance): void
    {
        ...
        $menu_instance->add_menu_item('bkash-settings-list-menu-items', [
            'route' => 'landlord.admin.payment.bkash.settings',
            'label' => __('Bkash'),
            'parent' => 'payment_gateway-manage-settings-menu-items',
            'permissions' => [],
        ]);
    ...
    public function render_tenant_sidebar_menus(): string
    {
        ...
        if (!empty($current_tenant_payment_data)) {
            ...
            if (!empty($package)) {
                ...
                if (in_array('google', $check_all_feature)) {
                    $this->tenant_google_settings_menus($menu_instance);
                }
    ...
    private function tenant_google_settings_menus(MenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('google-settings-menu-items', [
            'route' => '#',
            'label' => __('Google Services'),
...
//        ]);
    ...
    private function tenant_payment_gateway_manage_menus(MenuWithPermission $menu_instance): void
    {
        ...
        if (in_array('bkash', $check_all_feature)) {
            $menu_instance->add_menu_item('bkash-settings-list-menu-items', [
                'route' => 'tenant.admin.payment.bkash.settings',
                'label' => __('Bkash'),
                'parent' => 'payment_gateway-manage-settings-menu-items',
                'permissions' => [],
            ]);
