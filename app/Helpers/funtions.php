...
function global_assets_path($path)
{
    ...
    $bucket = $awsBucket;
    $s3Url = "https://{$bucket}.s3.amazonaws.com/{$path}";
    // dd($s3Url);

    return $s3Url;
    // /www/wwwroot/multipurc.com/assets/tenant/uploads/media-uploader/bestoffer24shop/
    // assets/tenant/uploads/media-uploader/bestoffer24shop/
    // /www/wwwroot/multipurc.com/core/public/assets/tenant/uploads/media-uploader/bestoffer24shop/
