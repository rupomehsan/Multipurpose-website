...
class GeneralSettingsController extends Controller
{
    ...
    public function update_third_party_script_settings(Request $request)
    {
        ...
        update_static_option('facebook_messenger_id', $request->facebook_messenger_id);
        ...
        if(!tenant()) {
            setEnvValue([
                ...
                'FACEBOOK_MESSENGER_ID' => $request->facebook_messenger_id,
        ...
        if(tenant()){
            ...
            setEnvValue([
                ...
                'TENANT_FACEBOOK_MESSENGER_ID' => $request->facebook_messenger_id,
